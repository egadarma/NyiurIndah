      ...
      if ($this->session->flashdata('pesan')) {
        ...
        echo'</div>';
                ...
                echo form_open('pelanggan/login'); ?>
                  ...
                  <button type="submit" class="btn btn-dark  btn-lg mb-4" >Login</button>
                <?php echo form_close() ?>
                <p class="login-card-footer-text">Belum punya akun? <a href="<?=base_url('pelanggan/register')?>" class="text-reset">Register</a></p>
            </div>
          </div>
        </div>
      </div>
