<div class="col-md-12">
            ...
            echo form_open_multipart('gambarbarang/add/' . $barang->id_barang) ?>
                <div class="form-group">
                    ...
                    <input name='ket' class="form-control" placeholder="Keterangan Gambar"  
                    value="<?= set_value('ket')?>">
                  </div>
                  <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                  <div class="form-group">
                        <img src="<?= base_url('asset/images/es_teh.jpg')?>" id="gambar_load" width="250px" height="200px">
                  </div>
                  </div>
                  </div>
                  <div class="form-group">
                    ...
                    <?php foreach ($gambar as $key => $value) { ?>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <img src="<?= base_url('asset/images_barang/'.$value->gambar)?>" id="gambar_load" width="250px" height="200px">
                            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Gambar <?= $value->ket ?></h4>
